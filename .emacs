...
(load-file "~/.emacs.d/lisps/unicad.el")


;;----------------------------------------------------------
;;MarkDown Mode
;;----------------------------------------------------------
(autoload 'markdown-mode "~/.emacs.d/lisps/markdown-mode.el" "Major mode for editing Markdown files" t)
...
;; 日历设置
;;----------------------------------------------------------
(load-file "~/.emacs.d/lisps/cal-china-x.el")
(require 'cal-china-x)
...
(load-file "~/.emacs.d/site-lisp/cedet-1.0.1/semantic/bovine/semantic-gcc.el")
